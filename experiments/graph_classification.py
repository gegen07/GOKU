...
from models.graph_model import GNN, FNSD
...
class Experiment:
    ...
    def run(self):
        ...
        for epoch in range(1, 1 + self.args.max_epochs):
            ...
            if epoch % self.args.eval_every == 0:
                train_acc, train_loss = self.eval(loader=train_loader)
                validation_acc, validation_loss = self.eval(loader=validation_loader)
                test_acc, test_loss = self.eval(loader=test_loader)
                ...
                if self.args.stopping_criterion == "train":
                    ...
                    elif validation_acc > best_validation_acc or validation_loss < best_validation_loss:
                        best_train_acc = train_acc
                        best_validation_acc = validation_acc
                        best_test_acc = test_acc
    ...
    def eval(self, loader):
        ...
        return total_correct / sample_size, total_loss / sample_size
